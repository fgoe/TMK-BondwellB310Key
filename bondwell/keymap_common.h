...
/* Bondwell keymap definition macro
...
#define KEYMAP( \
    ...
    { KC_##K50, KC_##K51, KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_##K56, KC_NO,    KC_NO,    KC_NO,    KC_##K5A, KC_##K5B, KC_##K5C, KC_##K5D }  \
}
